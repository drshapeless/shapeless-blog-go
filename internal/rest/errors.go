...
func (app *Application) notAllowedResponse(w http.ResponseWriter, r *http.Request) {
	message := "the current operation is not allowed"
	app.errorResponse(w, r, http.StatusBadRequest, message)
}

func (app *Application) fileSizeErrorResponse(w http.ResponseWriter, r *http.Request) {
	message := "the size of the uploaded file is too large"
	app.errorResponse(w, r, http.StatusBadRequest, message)
}

func (app *Application) signatureNotExistResponse(w http.ResponseWriter, r *http.Request) {
